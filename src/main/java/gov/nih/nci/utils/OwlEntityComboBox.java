...
import edu.stanford.protege.search.lucene.tab.ui.OwlEntityComboBoxEditor;
import edu.stanford.protege.search.lucene.tab.ui.OwlEntityComboBoxPopupMenuListener;
//import edu.stanford.protege.search.lucene.tab.ui.SortedComboBoxModel;
...
public class OwlEntityComboBox extends JComboBox<OWLEntity> {
    private static final long serialVersionUID = -6077318896483153369L;
    ...
    public OwlEntityComboBox(OWLEditorKit editorKit2, List<OWLEntity> properties) {
		super(properties.toArray(new OWLEntity[properties.size()]));
		this.editorKit = checkNotNull(editorKit2);
        entityFinder = editorKit.getModelManager().getOWLEntityFinder();
        model = new SortedComboBoxModel<>(new Comparator() {
    ...
    private void initUi() {
        ...
        setPreferredSize(new Dimension(0, 21));
